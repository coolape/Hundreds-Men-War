...
public class CLEjector : MonoBehaviour
{
	...
	public void fire (int numPoints, int numEach, float angle, CLUnit attacker, CLUnit target, object attr, object data, object callbak)
	{
		fire (-1, numPoints, numEach, angle, 0.15f, attacker, target, attr, data, callbak);
	}

	public void fire (int numPoints, int numEach, float angle, float offsetTime, CLUnit attacker, CLUnit target, object attr, object data, object callbak)
	{
		fire (-1, numPoints, numEach, angle, offsetTime, attacker, target, attr, data, callbak);
	}
